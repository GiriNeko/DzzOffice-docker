...
RUN DEBIAN_FRONTEND=noninteractive && sed -i s/deb.debian.org/mirrors.ustc.edu.cn/g /etc/apt/sources.list && sed -i s/security.debian.org/mirrors.ustc.edu.cn/g /etc/apt/sources.list \
